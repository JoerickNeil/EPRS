<?php
    ...
    require($_SERVER['DOCUMENT_ROOT'] . '/Dynamics/superadminfunction.php');
    ...
    <div class="navbar navbar-default navbar-fixed-top" style="background-color: red;">
        <div class="container">
            <div class="navbar-header">
                <a id="home" href="<?php echo app_path ?>SuperAdmin" class="navbar-brand" style="color: white;"> Dynamics Super Administrator</a>
                ...
                <ul class="nav navbar-nav pull-right" <?php toggleUser(); ?>>
                    <li id="user" class="dropdown" visible="true">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo app_path ?>SuperAdmin/profile.php">View Profile</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo app_path ?>SuperAdmin/logout.php">Logout</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
