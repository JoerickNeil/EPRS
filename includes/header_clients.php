<?php
    ...
    require($_SERVER['DOCUMENT_ROOT'] . '/Dynamics/clientfunction.php');
    ...
    <div class="navbar navbar-default navbar-fixed-top" style="background-color: red;">
        <div class="container">
            <div class="navbar-header">
                <a id="home" href="<?php echo app_path ?>clients" class="navbar-brand" style="color: white;"> Dynamics Clients</a>
            ...
            <div class="navbar-collapse collapse" id="navbar-main" style="height: 1px;">
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo app_path ?>clients/jobs">View Jobs</a></li>
                            <li class="divider"></li>
                        </ul>
                    </li>
                </ul>
				<ul class="nav navbar-nav pull-right" <?php toggleUser(); ?>>
                    <li id="user" class="dropdown" visible="true">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo app_path ?>clients/profile.php">View Profile</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo app_path ?>clients/logout.php">Logout</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
