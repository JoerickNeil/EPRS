<?php
    ...
    require($_SERVER['DOCUMENT_ROOT'] . '/Dynamics/employeefunction.php');
    ...
    <div class="navbar navbar-default navbar-fixed-top" style="background-color: red;">
        <div class="container">
            <div class="navbar-header">
                <a id="home" href="<?php echo app_path ?>employee" class="navbar-brand" style="color: white;"> Dynamics Employee</a>
            ...
            <div class="navbar-collapse collapse" id="navbar-main" style="height: 1px;">
                <ul class="nav navbar-nav">
					<li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo app_path ?>employee/Schedules/add.php">Add Schedule</a></li>
                            <li class="divider"></li>
                        </ul>
                    </li>
				 ...
				 <ul class="nav navbar-nav">
					<li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" id="schedule" href="#" style="color: white;">Logs<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo app_path ?>employee/logs/logs.php">View Logs</a></li>
                            <li class="divider"></li>
                        </ul>
                    </li>
                ...
                <ul class="nav navbar-nav pull-right" <?php toggleUser(); ?>>
                    <li id="user" class="dropdown" visible="true">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo app_path ?>employee/profile.php">View Profile</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo app_path ?>employee/logout.php">Logout</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
