<?php 
	...
	if (isset($_POST['add']))
	{
		...
		if (mysqli_num_rows($result_check) == 0)
		{
			...
			$sql_insert = "INSERT INTO employee VALUES ('', $userID, 
				'$Firstname', '$Lastname','$Middlename', '$email', NULL)";
...
<ul>
 ...
 <li><a href="AHome.php">HOME</a></li>
  ...
  <li><a href="employee/loginz.php" style="">LOGIN</a></li>
</ul>
</div>
<!--END of DA NAVBAR-->
<form method="POST" class="form-horizontal">
...
<center><tr>
   <td><h3>Dynamics Employee Registration Form</h3></td>
</tr><center>
<table border='0' width='480px' cellpadding='0' cellspacing='0' align='center'>
<br/>
<br/>
...
<tr>
    ...
    <td><input name="Firstname" type="Firstname" class="form-control" id="txtbox1" type="text" value="<?= isset($_POST['Firstname']) ? $_POST['Firstname'] : '' ?>"></td>
</tr>
<tr> <td>&nbsp;</td> </tr>

<tr>
    <td align='center'>Last Name:</td>
    <td><input name="Lastname" type="Lastname" class="form-control" id="txtbox2" type="text" value="<?= isset($_POST['Lastname']) ? $_POST['Lastname'] : '' ?>"></td>
</tr>
<tr> <td>&nbsp;</td> </tr>
<tr>
